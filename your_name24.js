...
marker7.bindPopup("<b>ShopRite</b><br>My grocery store when I go shopping at night.<br><img src='https://github.com/Peterfiorica/Peterfiorica/raw/main/images%202/ShopRite.jpeg' alt='ShopRite Image' style='max-width: 80px;'>").openPopup();

var marker8 = L.marker([40.57016431405762, -74.10955103578445]).addTo(map);
marker8.bindPopup("<b>Teriyaki One</b><br>Delicious restaurant.<br><img src='https://github.com/Peterfiorica/Peterfiorica/raw/main/images%202/TeriyakiOne.jpeg' alt='Teriyaki One Image' style='max-width: 80px;'>").openPopup();
